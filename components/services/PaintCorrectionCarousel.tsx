...
const IMAGES = [
  "/images/services/paint-correction/Carousel/01.jpg",
  "/images/services/paint-correction/Carousel/02.JPG",
  "/images/services/paint-correction/Carousel/03.JPG",
  "/images/services/paint-correction/Carousel/04.jpg",
]

export default function PaintCorrectionCarousel() {
  ...
  return (
    <div className="srv-row-img" style={{ position: "relative" }}>
      ...
      <Image
        src={IMAGES[current]}
        alt={`Paint Correction ${current + 1}`}
        fill
